  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Directorio de Atletas</h1>
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="w-full sm:w-64 bg-black/40 border border-white/10 rounded-lg pl-10 pr-4 py-2 text-sm text-foreground focus:outline-none focus:border-primary"
          />
        </div>
      </div>
        ...
        {filteredAthletes.map((atleta) => {
          ...
          return (
            <Link key={atleta.id} href={`/atletas/${atleta.id}`}>
              <Card className="glass hover:border-primary/50 transition cursor-pointer group">
