  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative p-4 overflow-hidden">
      ...
      <div className="z-10 w-full max-w-md glass p-8 rounded-2xl flex flex-col items-center">
        ...
        <h1 className="text-3xl font-bold mb-2">GymPro</h1>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
                placeholder="Ej. 1234"
                required
              />
            </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/10 w-full text-center text-xs text-muted-foreground">
          <p>Credenciales de prueba:</p>
          <div className="mt-2 grid grid-cols-2 gap-2 text-left bg-black/40 p-3 rounded-lg">
